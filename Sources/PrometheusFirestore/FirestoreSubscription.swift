...
public struct FirestoreSubscription {
    
    public static func subscribe(id: String, docPath: String) -> AnyPublisher<DocumentSnapshot, Never> {
...
extension FirestoreSubscription {
    ...
    public static func subscribe(to query: Query,
...
extension FirestoreSubscription {
    ...
    public static func cancel(id: String, isQuery: Bool? = nil) {
        if (isQuery == true) {
